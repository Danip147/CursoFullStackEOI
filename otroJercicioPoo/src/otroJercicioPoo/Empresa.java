...
public class Empresa {
    ...
    public Empresa() {
    	direccion = new Direccion();					// NO OLVIDAR DAR MEMORIA PARA ALMACENAR LOS DIFERENTES OBJETOS
...
//		e.getJugadores().forEach(j -> this.jugadores.add(new Jugador(j)));
		e.getEmpleados().forEach(emp -> this.empleados.add(new Empleado(emp))); 			// Esto es una copia en profundidad
	}
