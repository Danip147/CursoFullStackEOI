package com.dani.harry.entidades;
...
public class Personaje implements Serializable{  // poner esto por defecto
	

	private static final long serialVersionUID = 1L; // Permite llevar un versionado de la clase
	private String id;
	private String name;
	...
	private transient LocalDate dateOfBirthLD; // atributo que no se va a almacenar TRANSIENT
